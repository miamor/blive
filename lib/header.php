...
<div class="page-content">
		<div class="left-menu-column sidebar-nicescroller">
			<div class="top-section">
				<span class="s-title"><span class="toggle-form">What you said!</span></span>
		...
		<div class="main-content sidebar-nicescroller">
			<div class="top-section">
				<span class="s-title"><span class="toggle-form">What you said!</span></span>
				<form method="post" enctype="multipart/form-data" data-p="feed" data-a="do=submitstt" class="status-form top-form up-caret" alt="<?php echo $member['id'] ?>" id="submitstt">
					...
					<div class="form-custom">
						...
						<div class="custom">
							<select name="privacy" class="p-privacy">
