	...
	* =============================== */
	...
	Confirmation.prototype = $.extend({}, $.fn.tooltip.Constructor.prototype, {
		...
		, setContent: function () {
				...
				$tip.find('.popover-text').text(content)
		...
		, getContent: function () {
				...
				content = $e.attr('data-content') || (typeof o.href == 'function' ? o.href.call($e[0]) :	o.href)
	...
	* ======================= */
	...
	$.fn.confirmation.defaults = $.extend({} , $.fn.tooltip.defaults, {
		...
		, template: '<div class="popover">' +
				...
				'<a class="popover-ok btn btn-small" href="" target=""></a>' +
				'<a class="popover-cancel btn btn-small" data-dismiss="confirmation"></a>' +
